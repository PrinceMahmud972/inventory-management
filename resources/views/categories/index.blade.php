        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
            <div class="card-body">
              ...
              <a href="{{ route('categories.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Category</a><br><br>
                            ...
                            @foreach ($categories as $key => $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:;" class="btn btn-danger btn-sm sa-delete" data-form-id="category-delete-{{ $category->id }}">
